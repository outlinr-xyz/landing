...
>(({ className, children, ...props }, forwardedRef) => (
  <AccordionPrimitives.Header className="flex">
    <AccordionPrimitives.Trigger
      className={cx(
        "group flex flex-1 cursor-pointer items-center justify-between py-3 text-left text-base font-semibold text-gray-900 leading-none",
        "text-gray-900",
...
>(({ className, children, ...props }, forwardedRef) => (
  ...
  >
    <div
      className={cx(
        "overflow-hidden pb-4 text-base",
        "text-gray-700",
        className,
      )}
    >
